...
category: tech
tags: r, exploratory analysis
summary: In this post I'm going to walk through the R package `ggpairs` and how it can help us quickly visualize the relationship between variables.
---
...
note <- read.table("/Users/kthomas1/github/r_code/data/data_banknote_authentication.txt",sep=",")
```
